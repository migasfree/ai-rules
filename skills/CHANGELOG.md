...
- **MAJOR**: `ui-designer-expert` upgraded to v2.0.0. Shifted from pure frontend implementation logic to a comprehensive Product Design mentality. Added rules for Typographic Mathematics (Golden ratio, `clamp()`), Optimistic UI, structural screen management (popovers vs modals vs toasts), Light-elevation Dark Mode architecture, natural UX writing, and enforced strict prohibition of inline styles.
...
- `ui-designer-expert`: Updated implementation guidelines to emphasize HTML minimalism and CSS generalization, and enforced semantic class naming criteria. Follows AI Prompt Expert standards.
